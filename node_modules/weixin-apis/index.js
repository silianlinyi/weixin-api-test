...
var Weixin = Events.extend({
    ...
    init: function(config) {
        ...
        // for test
        this.access_token = 'Biv8Ha4Nu-YiwC0oFW1Tpuj9KtmqNMVO-ygQDUaAZyOV7EjGUO5axWRDYzB0EtFd9SGA6a9tHRuEhoCvcR5sYda10GjH9RNa7OY0Ld-NDYk';
    ...
    getWeixinIPList: function(callback) {
        var url = config.GET_WEIXIN_IP_LIST + '?access_token=' + this.access_token;
        this.getRequest(url, callback);
    },
