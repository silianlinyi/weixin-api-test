...
var Weixin = Events.extend({
    ...
    init: function(config) {
        ...
        // for test
        this.access_token = 'rkP-Wis52R1jndPSb_Wpqbqucd51RqksRkJU_WV_qTYo2fopSkvWFmmHMiTZqGgEYl1RjHlDpW8XTGHi3vV9InqJHD2WInlcyUM1ees5fWI';
    ...
    getCurrentAutoReplyInfo: function(callback) {
        var url = config.GET_CURRENT_AUTOREPLY_INFO + '?access_token=' + this.access_token;
        this.getRequest(url, callback);
    },
    ...
    getMenu: function(callback) {
        var url = config.GET_MENU + '?access_token=' + this.access_token;
        this.getRequest(url, callback);
    },
    ...
    deleteMenu: function(callback) {
        var url = config.DELETE_MENU + '?access_token=' + this.access_token;
        this.getRequest(url, callback);
    },
    ...
    createMenu: function(menuObj, callback) {
        var self = this;
        var options = {
            url: config.CREATE_MENU + '?access_token=' + this.access_token,
            method: 'post',
    ...
    getCurrentSelfMenuInfo: function(callback) {
        var url = config.GET_CURRENT_SELF_MENU_INFO + '?access_token=' + this.access_token;
        console.log(url);
        this.getRequest(url, callback);
    },
